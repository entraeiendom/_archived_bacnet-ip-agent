package no.entra.bacnet.agent.simulators;
 ...
 */
public class BacnetUdpSimulator {
    private static final Logger log = LoggerFactory.getLogger( BacnetUdpSimulator.class );
    private DatagramSocket socket;
    public static final int BACNET_DEFAULT_PORT = 47808;
    private byte[] buf = new byte[2048];
    private InetAddress sendToAddress;

    public BacnetUdpSimulator() throws SocketException, UnknownHostException {
    ...
    public static void main(String[] args) {
        BacnetUdpSimulator simulator = null;
        String hexString = "810400180a3f510cbac00120ffff00ff10080a07ae1a07ae";
        //HexString may also be fetched as the first program argument.
        if (args.length > 0) {
            hexString = args[0];
        }
